    ...
    const fetchAllData = async () => {
      try {
        ...
        const [
          ...
          axios
            .get("https://atla-knots-admin.onrender.com/api/users")
            .catch(() => ({ data: null })),
          axios
            .get("https://atla-knots-admin.onrender.com/query")
            .catch(() => ({ data: null })),
          axios
            .get("https://atla-knots-admin.onrender.com/api/contact")
            .catch(() => ({ data: null })),
          axios
            .get("https://atla-knots-admin.onrender.com/api/technology/product")
            .catch(() => ({ data: null })),
          axios
            .get(
